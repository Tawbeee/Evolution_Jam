...
namespace AK
{
    namespace EVENTS
    {
        static const AkUniqueID PLAY_ISKILLED = 3385860117U;
        static const AkUniqueID PLAY_ISKILLEDBY_ARROW = 2095147940U;
        static const AkUniqueID PLAY_ISKILLEDBY_FALL = 3446595322U;
        static const AkUniqueID PLAY_ISKILLEDBY_LIGHTNING = 1734114553U;
        static const AkUniqueID PLAY_ISKILLEDBY_SPIKE = 201740281U;
        static const AkUniqueID PLAY_ISKILLEDBY_STOMP = 1365561248U;
        static const AkUniqueID PLAY_ISKILLEDBY_WATER = 3013923882U;
        static const AkUniqueID PLAY_JAM_EVOLUTION = 3075399896U;
        static const AkUniqueID PLAY_KILLINGOBJECT_ARROW = 2608619777U;
