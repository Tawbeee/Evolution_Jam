	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_TransmissionMaskMap = IN.ase_texcoord9.xy * _TransmissionMaskMap_ST.xy + _TransmissionMaskMap_ST.zw;
...
ASEEND*/
//CHKSM=7B05272765088AD71153D76F820AE1A1961B0105