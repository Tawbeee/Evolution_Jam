	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord80_g48 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord81_g48 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord78_g48 = IN.ase_texcoord9.xy * float2( 2,2 ) + float2( 0,0 );
				...
				float2 texCoord38 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
...
ASEEND*/
//CHKSM=C701A89E8CF21BC297C8E10292A6BB16752F5958