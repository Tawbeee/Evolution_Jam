	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 uv_Textured_Course_AlbedoTransparency = IN.ase_texcoord9.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				...
				float2 uv_Smoothness = IN.ase_texcoord9.xy * _Smoothness_ST.xy + _Smoothness_ST.zw;
...
ASEEND*/
//CHKSM=17CBA39251280428551DD24921F5FF034FA1D2AC