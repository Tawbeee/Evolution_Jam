	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord41 = IN.ase_texcoord9.xy * appendResult130 + appendResult46;
				float4 ShieldPattern17 = tex2D( _ShieldPattern, texCoord41 );
				float2 appendResult91 = (float2(1 , ( 1.0 - ( ShieldSpeed84 / 5.0 ) ).x));
				float2 texCoord87 = IN.ase_texcoord9.xy * float2( 1,1 ) + appendResult91;
				float4 waves94 = tex2D( _ShieldPatternWaves, texCoord87 );
				float temp_output_152_0 = distance( IN.ase_texcoord10.xyz , _HitPosition );
...
ASEEND*/
//CHKSM=254337933D1D311407A364E5E3A4111419421D08