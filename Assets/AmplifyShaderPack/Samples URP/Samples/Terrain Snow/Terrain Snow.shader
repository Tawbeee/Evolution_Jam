	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord9.xy = vertexToFrag286_g13;
				float2 vertexToFrag851_g13 = ( ( v.texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				o.ase_texcoord10.xy = vertexToFrag851_g13;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g13 = IN.ase_texcoord9.xy;
				...
				float2 uv_SnowMapSplat = IN.ase_texcoord9.zw * _SnowMapSplat_ST.xy + _SnowMapSplat_ST.zw;
				...
				float2 vertexToFrag851_g13 = IN.ase_texcoord10.xy;
...
/*ASEBEGIN
Version=19600
Node;AmplifyShaderEditor.FunctionNode;49;320,0;Inherit;False;Terrain 4 Layer;0;;13;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,669,1,668,1;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
...
ASEEND*/
//CHKSM=255BF01001781DCF3897E0112C752E7B09728322