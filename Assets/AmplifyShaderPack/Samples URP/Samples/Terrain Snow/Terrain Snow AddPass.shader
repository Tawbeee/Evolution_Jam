	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord9.xy = vertexToFrag286_g14;
				float2 vertexToFrag851_g14 = ( ( v.texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				o.ase_texcoord10.xy = vertexToFrag851_g14;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = IN.ase_texcoord9.xy;
				...
				float2 vertexToFrag851_g14 = IN.ase_texcoord10.xy;
...
/*ASEBEGIN
Version=19600
Node;AmplifyShaderEditor.FunctionNode;53;320,0;Inherit;False;Terrain 4 Layer;0;;14;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,669,1,668,1;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
Node;AmplifyShaderEditor.RangedFloatNode;64;288,256;Inherit;False;Constant;_AlphaClipThreshold1;AlphaClipThreshold;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=35A0B81EF283FC3A115FD179E4E1E8B5DF885F52