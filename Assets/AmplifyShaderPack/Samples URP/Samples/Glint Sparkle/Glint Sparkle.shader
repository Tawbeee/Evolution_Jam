	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Normals = IN.ase_texcoord9.xy * _Normals_ST.xy + _Normals_ST.zw;
				...
				float staticSwitch495 = IN.ase_texcoord10.xyz.x;
				#elif defined( _DIRECTION_Y )
				float staticSwitch495 = IN.ase_texcoord10.xyz.y;
				#elif defined( _DIRECTION_Z )
				float staticSwitch495 = IN.ase_texcoord10.xyz.z;
				#else
				float staticSwitch495 = IN.ase_texcoord10.xyz.y;
				#endif
...
ASEEND*/
//CHKSM=8795155A5C66D100DB3C88C7A2445249B7E0C9DA