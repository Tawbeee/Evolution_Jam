	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_32_0_g126 = ( IN.ase_texcoord9.xy * appendResult182 );
				...
				float4 tex2DNode178 = tex2D( _FacadeMap, ( ( IN.ase_texcoord9.xy * (_FacadeTilling).xy ) + (_FacadeTilling).zw ) );
				...
				float2 uv_Roof = IN.ase_texcoord9.xy * _Roof_ST.xy + _Roof_ST.zw;
...
ASEEND*/
//CHKSM=B2F219F858B7BD007D700CC78D5DCE75AF7B1E05