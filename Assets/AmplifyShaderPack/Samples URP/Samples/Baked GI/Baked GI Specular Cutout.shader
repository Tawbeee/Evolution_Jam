	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord9.zw = v.texcoord1.xy;
				o.ase_texcoord10.xy = v.texcoord2.xy;
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g37 = ( ( IN.ase_texcoord9.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				float MapBaseColorAlpha107_g37 = tex2DNode21_g37.a;
				...
				float2 temp_output_1219_0_g32 = (IN.ase_texcoord9.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g32 = temp_output_1219_0_g32;
				float2 staticUV965_g32 = UV1Static1247_g32;
				float2 temp_output_1255_0_g32 = (IN.ase_texcoord10.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float Alpha = MapBaseColorAlpha107_g37;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 temp_output_133_0_g37 = ( ( IN.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g37 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g37 );
				float MapBaseColorAlpha107_g37 = tex2DNode21_g37.a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 temp_output_133_0_g37 = ( ( IN.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g37 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g37 );
				float MapBaseColorAlpha107_g37 = tex2DNode21_g37.a;
				

				surfaceDescription.Alpha = MapBaseColorAlpha107_g37;
...
Node;AmplifyShaderEditor.FunctionNode;53;192,272;Inherit;False;Material Baked GI;35;;32;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
WireConnection;43;11;53;948
ASEEND*/
//CHKSM=D224C717B6F7F1C0B08957CCA31C26E1D24E9317