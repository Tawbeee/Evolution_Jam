	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_334_0 = ( ( IN.ase_texcoord9.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
...
ASEEND*/
//CHKSM=14977BD7D7A4CE80A8E7B635BFBD267D6965C595