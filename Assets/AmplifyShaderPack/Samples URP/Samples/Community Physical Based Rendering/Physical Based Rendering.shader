...
Shader "AmplifyShaderPack/Community/Physical Based Rendering"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 AdditionalLightsSpecular17x( float3 WorldPosition, float2 ScreenUV, float3 WorldNormal, float3 WorldView, float3 SpecColor, float Smoothness )
			{
				float3 Color = 0;
			...
			float3 AdditionalLightsHalfLambert17x( float3 WorldPosition, float2 ScreenUV, float3 WorldNormal )
			{
				float3 Color = 0;
				#if defined(_ADDITIONAL_LIGHTS)
				 ...
				 ) : SV_Target
			{
				...
				float3 WorldPosition165_g61277 = worldPosValue184_g61277;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g61277 = (ase_screenPosNorm).xy;
				float2 ScreenUV165_g61277 = ScreenUV183_g61277;
				...
				float3 WorldNormal165_g61277 = worldNormalValue185_g61277;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 temp_output_15_0_g61277 = ase_worldViewDir;
				float3 WorldView165_g61277 = temp_output_15_0_g61277;
				float3 temp_output_14_0_g61277 = _IndirectSpecularColor;
				float3 SpecColor165_g61277 = temp_output_14_0_g61277;
				float temp_output_18_0_g61277 = _IndirectSpecularSmoothness;
				float Smoothness165_g61277 = temp_output_18_0_g61277;
				float3 localAdditionalLightsSpecular17x165_g61277 = AdditionalLightsSpecular17x( WorldPosition165_g61277 , ScreenUV165_g61277 , WorldNormal165_g61277 , WorldView165_g61277 , SpecColor165_g61277 , Smoothness165_g61277 );
				...
				float3 temp_output_575_0_g1 = ( localAdditionalLightsSpecular17x165_g61277 + temp_output_574_0_g1 );
				...
				float3 temp_cast_2 = (grazingTerm703_g61195).xxx;
				...
				float3 lerpResult670_g61195 = lerp( specColor651_g61195 , temp_cast_2 , ( temp_output_676_0_g61195 * temp_output_676_0_g61195 * temp_output_676_0_g61195 * temp_output_676_0_g61195 * temp_output_676_0_g61195 ));
				...
				float3 WorldPosition172_g61278 = worldPosValue184_g61278;
				float2 ScreenUV183_g61278 = (ase_screenPosNorm).xy;
				float2 ScreenUV172_g61278 = ScreenUV183_g61278;
				float3 worldNormalValue185_g61278 = WorldNormalTangent1160_g1;
				float3 WorldNormal172_g61278 = worldNormalValue185_g61278;
				float3 localAdditionalLightsHalfLambert17x172_g61278 = AdditionalLightsHalfLambert17x( WorldPosition172_g61278 , ScreenUV172_g61278 , WorldNormal172_g61278 );
				float3 bakedGI607_g1 = ASEBakedGI( WorldPosition, WorldNormalTangent1160_g1, ( uint2 )( ase_screenPosNorm.xy * _ScreenSize.xy ), (IN.ase_texcoord4.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (IN.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw), true);
				...
				float3 Indirect_Diffuse644_g1 = ( ( ( localAdditionalLightsHalfLambert17x172_g61278 + bakedGI607_g1 ) * _IndirectDiffuse ) * Occlusion435_g1 );
