	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult336 = (float2(IN.ase_texcoord9.xyz.y , IN.ase_texcoord9.xyz.z));
				...
				float2 appendResult335 = (float2(IN.ase_texcoord9.xyz.x , IN.ase_texcoord9.xyz.z));
				float2 appendResult334 = (float2(IN.ase_texcoord9.xyz.x , IN.ase_texcoord9.xyz.y));
				float WorldObjectSwitch192 = _WorldtoObjectSwitch;
				float3 lerpResult187 = lerp( WorldPosition , IN.ase_texcoord9.xyz , WorldObjectSwitch192);
				float3 break287 = lerpResult187;
				float2 appendResult333 = (float2(break287.x , break287.z));
				float2 appendResult332 = (float2(IN.ase_texcoord9.xyz.y , IN.ase_texcoord9.xyz.z));
				float2 appendResult331 = (float2(IN.ase_texcoord9.xyz.x , IN.ase_texcoord9.xyz.z));
				float2 appendResult330 = (float2(IN.ase_texcoord9.xyz.x , IN.ase_texcoord9.xyz.y));
				float2 uv_TopNormal = IN.ase_texcoord10.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
...
ASEEND*/
//CHKSM=BD035D8B8C1D2C7BE88BFB0AD827209EA2A7FAB2